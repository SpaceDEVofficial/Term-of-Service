## 1. 개인정보 처리의 목적
"링크 단축 서비스"(' https://url.spacedev.space ') 는 다음 목적을 위하여 개인정보를 처리하고 있으며, 다음 목적 이외의 용도로는 사용하지 않습니다.
...
- 성명: 김정훈
- 직책: 대표
- 연락처: [메일](popop0982@naver.com) 혹은 디스코드 @gawi#9537
...
|------------|-----------|-------------|
| GalaxyGate | 요청 로그 등 | 서비스 및 서버 자원의 사용량 등을 모니터링, 디버깅 |
